...
def get_version() -> str:
    path = os.path.join(
        os.path.abspath(os.path.dirname(__file__)), "pyclhash", "__init__.py"
    )
...
def main():
    ...
    setup(
        name="pyclhash",
        version=version,
        url="https://github.com/synodriver/pyclhash",
        packages=packages,
        keywords=["hash", "clhash"],
        description="python binding for clhash",
