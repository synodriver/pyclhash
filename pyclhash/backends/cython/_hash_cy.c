...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pyclhash.backends.cython._hash_cy",
        "sources": [
            "pyclhash/backends/cython/_hash_cy.pyx",
            "./dep/src/clhash.c"
        ]
    },
    "module_name": "pyclhash.backends.cython._hash_cy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyclhash__backends__cython___hash_cy
#define __PYX_HAVE_API__pyclhash__backends__cython___hash_cy
/* Early includes */
#include <string.h>
#include <stdio.h>
#include <stdint.h>
...
/* Module declarations from 'pyclhash.backends.cython._hash_cy' */
...
static void __pyx_f_8pyclhash_8backends_6cython_8_hash_cy_delkey(PyObject *); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed(uint64_t, uint64_t, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE uint64_t __pyx_f_8pyclhash_8backends_6cython_8_hash_cy_hash(__Pyx_memviewslice, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pyclhash.backends.cython._hash_cy"
extern int __pyx_module_is_main_pyclhash__backends__cython___hash_cy;
int __pyx_module_is_main_pyclhash__backends__cython___hash_cy = 0;

/* Implementation of 'pyclhash.backends.cython._hash_cy' */
...
static PyObject *__pyx_pf_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed(CYTHON_UNUSED PyObject *__pyx_self, uint64_t __pyx_v_seed1, uint64_t __pyx_v_seed2); /* proto */
static PyObject *__pyx_pf_8pyclhash_8backends_6cython_8_hash_cy_2hash(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_seed); /* proto */
...
/* "pyclhash/backends/cython/_hash_cy.pyx":14
...
static void __pyx_f_8pyclhash_8backends_6cython_8_hash_cy_delkey(PyObject *__pyx_v_o) {
  void *__pyx_v_p;
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":15
 * 
 * cdef void delkey(object o):
 *     cdef void* p = PyCapsule_GetPointer(o, NULL)             # <<<<<<<<<<<<<<
 *     # print("delkey", <uint64_t>p)
 ...
 */
  __pyx_t_1 = PyCapsule_GetPointer(__pyx_v_o, NULL); if (unlikely(__pyx_t_1 == ((void *)NULL) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_v_p = __pyx_t_1;

  /* "pyclhash/backends/cython/_hash_cy.pyx":17
 *     cdef void* p = PyCapsule_GetPointer(o, NULL)
 *     # print("delkey", <uint64_t>p)
 *     clhash.free_key(p)  # origin one does not handle windows condition             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("pyclhash.backends.cython._hash_cy.delkey", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "pyclhash/backends/cython/_hash_cy.pyx":19
 *     clhash.free_key(p)  # origin one does not handle windows condition
 * 
 * cpdef inline object get_random_seed(uint64_t seed1, uint64_t seed2):             # <<<<<<<<<<<<<<
 *     cdef void* p
...
static PyObject *__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_1get_random_seed(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed(uint64_t __pyx_v_seed1, uint64_t __pyx_v_seed2, CYTHON_UNUSED int __pyx_skip_dispatch) {
  void *__pyx_v_p;
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":21
 * cpdef inline object get_random_seed(uint64_t seed1, uint64_t seed2):
 *     cdef void* p
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pyclhash/backends/cython/_hash_cy.pyx":22
 *     cdef void* p
 *     with nogil:
 *         p = clhash.get_random_key_for_clhash(seed1, seed2)             # <<<<<<<<<<<<<<
 *     # print("new", <uint64_t>p)
 ...
 */
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":24
 *         p = clhash.get_random_key_for_clhash(seed1, seed2)
 *     # print("new", <uint64_t>p)
 *     if p == NULL:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyclhash/backends/cython/_hash_cy.pyx":25
 *     # print("new", <uint64_t>p)
 *     if p == NULL:
 *         raise ValueError("got null")             # <<<<<<<<<<<<<<
 *     return PyCapsule_New(p, NULL, delkey)
 ...
 */
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":26
 *     if p == NULL:
 *         raise ValueError("got null")
 *     return PyCapsule_New(p, NULL, delkey)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = PyCapsule_New(__pyx_v_p, NULL, __pyx_f_8pyclhash_8backends_6cython_8_hash_cy_delkey); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("pyclhash.backends.cython._hash_cy.get_random_seed", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_1get_random_seed(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed[] = "get_random_seed(uint64_t seed1, uint64_t seed2)";
static PyObject *__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_1get_random_seed(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("get_random_seed (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seed2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_random_seed", 1, 2, 2, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_random_seed") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    ...
    __pyx_v_seed1 = __Pyx_PyInt_As_uint64_t(values[0]); if (unlikely((__pyx_v_seed1 == ((uint64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_seed2 = __Pyx_PyInt_As_uint64_t(values[1]); if (unlikely((__pyx_v_seed2 == ((uint64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_random_seed", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyclhash.backends.cython._hash_cy.get_random_seed", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed(__pyx_self, __pyx_v_seed1, __pyx_v_seed2);
...
static PyObject *__pyx_pf_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed(CYTHON_UNUSED PyObject *__pyx_self, uint64_t __pyx_v_seed1, uint64_t __pyx_v_seed2) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("get_random_seed", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed(__pyx_v_seed1, __pyx_v_seed2, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
...
/* "pyclhash/backends/cython/_hash_cy.pyx":28
 *     return PyCapsule_New(p, NULL, delkey)
 * 
 * cpdef inline uint64_t hash(const uint8_t[::1] data, object seed) except? 0:             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_3hash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE uint64_t __pyx_f_8pyclhash_8backends_6cython_8_hash_cy_hash(__Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_seed, CYTHON_UNUSED int __pyx_skip_dispatch) {
  void *__pyx_v_p;
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":29
 * 
 * cpdef inline uint64_t hash(const uint8_t[::1] data, object seed) except? 0:
 *     if not PyCapsule_CheckExact(seed) and not PyBytes_Check(seed):             # <<<<<<<<<<<<<<
 *         raise ValueError("invalid seed, should be a capsule or a bytes")
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pyclhash/backends/cython/_hash_cy.pyx":30
 * cpdef inline uint64_t hash(const uint8_t[::1] data, object seed) except? 0:
 *     if not PyCapsule_CheckExact(seed) and not PyBytes_Check(seed):
 *         raise ValueError("invalid seed, should be a capsule or a bytes")             # <<<<<<<<<<<<<<
 *     cdef:
 *         void * p
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 30, __pyx_L1_error)
 ...
 */
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":34
 *         void * p
 *         uint64_t ret
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pyclhash/backends/cython/_hash_cy.pyx":35
 *         uint64_t ret
 *     if PyBytes_Check(seed):
 *         if <int>PyBytes_GET_SIZE(seed) < RANDOM_BYTES_NEEDED_FOR_CLHASH:             # <<<<<<<<<<<<<<
 *             raise ValueError("seed is too short")
 ...
 */
    __pyx_t_3 = __Pyx_PyInt_From_int(((int)PyBytes_GET_SIZE(__pyx_v_seed))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_RANDOM_BYTES_NEEDED_FOR_CLHASH); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 35, __pyx_L1_error)
    ...
    if (unlikely(__pyx_t_1)) {
      ...
      /* "pyclhash/backends/cython/_hash_cy.pyx":36
 *     if PyBytes_Check(seed):
 *         if <int>PyBytes_GET_SIZE(seed) < RANDOM_BYTES_NEEDED_FOR_CLHASH:
 *             raise ValueError("seed is too short")             # <<<<<<<<<<<<<<
 *         p = <void *>PyBytes_AS_STRING(seed)
 *     else:
 */
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 36, __pyx_L1_error)
 ...
 */
    ...
    /* "pyclhash/backends/cython/_hash_cy.pyx":37
 *         if <int>PyBytes_GET_SIZE(seed) < RANDOM_BYTES_NEEDED_FOR_CLHASH:
 *             raise ValueError("seed is too short")
 *         p = <void *>PyBytes_AS_STRING(seed)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":39
 *         p = <void *>PyBytes_AS_STRING(seed)
 *     else:
 *         p = PyCapsule_GetPointer(seed, NULL)             # <<<<<<<<<<<<<<
 *         # print("new", <uint64_t> p)
 ...
 */
  /*else*/ {
    __pyx_t_6 = PyCapsule_GetPointer(__pyx_v_seed, NULL); if (unlikely(__pyx_t_6 == ((void *)NULL) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
    __pyx_v_p = __pyx_t_6;
  }
  __pyx_L6:;

  /* "pyclhash/backends/cython/_hash_cy.pyx":41
 *         p = PyCapsule_GetPointer(seed, NULL)
 *         # print("new", <uint64_t> p)
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pyclhash/backends/cython/_hash_cy.pyx":42
 *         # print("new", <uint64_t> p)
 *     with nogil:
 *         ret = clhash.clhash(p, <char*>&data[0], <size_t>data.shape[0])             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":43
 *     with nogil:
 *         ret = clhash.clhash(p, <char*>&data[0], <size_t>data.shape[0])
 *     return ret             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("pyclhash.backends.cython._hash_cy.hash", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_3hash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8pyclhash_8backends_6cython_8_hash_cy_2hash[] = "hash(const uint8_t[::1] data, seed) -> uint64_t";
static PyObject *__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_3hash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seed)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("hash", 1, 2, 2, 1); __PYX_ERR(0, 28, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "hash") < 0)) __PYX_ERR(0, 28, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("hash", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 28, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyclhash.backends.cython._hash_cy.hash", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8pyclhash_8backends_6cython_8_hash_cy_2hash(__pyx_self, __pyx_v_data, __pyx_v_seed);
...
static PyObject *__pyx_pf_8pyclhash_8backends_6cython_8_hash_cy_2hash(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_seed) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  uint64_t __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_t_1 = __pyx_f_8pyclhash_8backends_6cython_8_hash_cy_hash(__pyx_v_data, __pyx_v_seed, 0); if (unlikely(__pyx_t_1 == ((uint64_t)0) && PyErr_Occurred())) __PYX_ERR(0, 28, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyInt_From_uint64_t(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyclhash.backends.cython._hash_cy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyclhash.backends.cython._hash_cy.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyclhash.backends.cython._hash_cy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyclhash.backends.cython._hash_cy._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_random_seed", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_1get_random_seed, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8pyclhash_8backends_6cython_8_hash_cy_get_random_seed},
  {"hash", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8pyclhash_8backends_6cython_8_hash_cy_3hash, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8pyclhash_8backends_6cython_8_hash_cy_2hash},
  {0, 0, 0, 0}
};
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_got_null); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 *         void * p
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_u_invalid_seed_should_be_a_capsule); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 30, __pyx_L1_error)
 ...
 *     else:
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_u_seed_is_too_short); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 36, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pyclhash__backends__cython___hash_cy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyclhash.backends.cython._hash_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "pyclhash.backends.cython._hash_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyclhash/backends/cython/_hash_cy.pyx":11
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(RANDOM_64BITWORDS_NEEDED_FOR_CLHASH); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_RANDOM_64BITWORDS_NEEDED_FOR_CLH, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pyclhash/backends/cython/_hash_cy.pyx":12
 * 
 * RANDOM_64BITWORDS_NEEDED_FOR_CLHASH = clhash.RANDOM_64BITWORDS_NEEDED_FOR_CLHASH
 * RANDOM_BYTES_NEEDED_FOR_CLHASH = clhash.RANDOM_BYTES_NEEDED_FOR_CLHASH             # <<<<<<<<<<<<<<
 * 
 * cdef void delkey(object o):
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(RANDOM_BYTES_NEEDED_FOR_CLHASH); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_RANDOM_BYTES_NEEDED_FOR_CLHASH, __pyx_t_1) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pyclhash/backends/cython/_hash_cy.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyclhash.backends.cython._hash_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyclhash.backends.cython._hash_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
